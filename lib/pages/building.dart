          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  "Find the Building of Your Dream.",
                  style: TextStyle(
        ...
        (index) => GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    PropertyDetailPage(property: building[index]),
              ),
            );
          },
          child: PropertyItem(
            ...
            onFavoriteChanged: (isFavorite) {
              setState(() {
                building[index]["is_favorited"] = isFavorite;
              });
            },
          ),
        ),
        ...
        (index) => GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    PropertyDetailPage(property: building2[index]),
              ),
            );
          },
          child: PropertyItem(
            data: building2[index],
            onFavoriteChanged: (isFavorite) {
              setState(() {
                building2[index]["is_favorited"] = isFavorite;
              });
            },
          ),
        ),
