        ...
        (index) => GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    PropertyDetailPage(property: flats[index]),
              ),
            );
          },
          child: PropertyItem(
            ...
            onFavoriteChanged: (isFavorite) {
              setState(() {
                flats[index]["is_favorited"] = isFavorite;
              });
            },
          ),
        ),
        ...
        (index) => GestureDetector(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    PropertyDetailPage(property: flats2[index]),
              ),
            );
          },
          child: PropertyItem(
            ...
            onFavoriteChanged: (isFavorite) {
              setState(() {
                flats2[index]["is_favorited"] = isFavorite;
              });
            },
          ),
        ),
